...
#
# Assumes the input matrix is in $./genotypes.txt$ and has header $AA,AB,BB$,
# where AA=homref, AB=het, BB=homvar. Writes the output to $out.png$.
#
# It runs without problems in the following cloud environment: 
# Legacy R / Bioconductor (R 4.2.2, Bioconductor 3.16, Python 3.7.12) 
#
# @param args 0=input GT count matrix; 1=output PNG.
#
