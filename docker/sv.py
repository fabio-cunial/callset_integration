...
SV_TYPES = ['UNK', 'unk', 'BND', 'bnd', 'DEL', 'del', 'INS', 'ins', 'INV', 'inv']
...
class SV(object):
    ...
    def __init__(self, vcf_record, check_type = True, join_mode = False, output_ids = False):
        ...
        if "SVTYPE" in info_dict:
            if info_dict["SVTYPE"] == "DEL_ALU" or info_dict["SVTYPE"] == "del_alu" or info_dict["SVTYPE"] == "DEL_LINE1" or info_dict["SVTYPE"] == "del_line1":
                info_dict["SVTYPE"] = "DEL"
            elif info_dict["SVTYPE"] == "ALU" or info_dict["SVTYPE"] == "alu" or info_dict["SVTYPE"] == "LINE1" or info_dict["SVTYPE"] == "line1" or info_dict["SVTYPE"] == "SVA" or info_dict["SVTYPE"] == "sva" or \
                 info_dict["SVTYPE"] == "DUP" or info_dict["SVTYPE"] == "dup" or info_dict["SVTYPE"] == "CNV" or info_dict["SVTYPE"] == "cnv" or info_dict["SVTYPE"] == "INVDUP" or info_dict["SVTYPE"] == "invdup" or \
                 info_dict["SVTYPE"] == "INV" or info_dict["SVTYPE"] == "inv":
                info_dict["SVTYPE"] = "INS"
            elif info_dict["SVTYPE"] == "TRA" or info_dict["SVTYPE"] == "tra":
        ...
        if "SVTYPE" in info_dict and (info_dict["SVTYPE"] == "DEL" or info_dict["SVTYPE"] == "del"):
            if "END" in info_dict:
